    ...
    books: [
        {
            ...
            preview: [
                "./res/img/materials/book_04.jpg",
                "./res/img/materials/book_04_1.jpg",
                "./res/img/materials/book_04_2.jpg",
                "./res/img/materials/book_04_3.jpg",
                "./res/img/materials/book_04_4.jpg",
                "./res/img/materials/book_04_5.jpg",
                "./res/img/materials/book_04_6.jpg"
            ]
        }, {
...
const DataStorage = (function () {
    ...
    function dataRandom(data) {
        const resources = exports.data.books.concat(exports.data.magazines).concat(exports.data.software);

        //Resid generation
        let resid = 0;
        resources.forEach(book => book.resid = resid++);

        //amount
        resources.forEach(book => book.copy = Math.floor(Math.random() * 10) + 2)
        resources.forEach(book => book.lended = Math.floor(Math.random() * book.copy / 2))
        resources.forEach(book => book.reservedLended = Math.floor(Math.random() * (book.lended) / 2))
        resources.forEach(book => book.reserved = Math.floor(Math.random() * (book.copy - book.lended) / 2))
        resources.forEach(book => book.available = book.copy - book.lended - book.reserved)
